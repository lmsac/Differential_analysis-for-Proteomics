...
threshold_frame = pd.read_csv(
	'/home/xuguanyang/py/Differential_analysis/reference_data/thershold_TMT.csv')
threshold_dict = dict(zip(threshold_frame['algorithm'], threshold_frame['threshold']))
print(threshold_frame)
all_res = pd.DataFrame()
col1, col2, col3 = [], [], []
# for x in ['10', '20', '40', '60', '80', '100']:
for x in ['10']:
	# dirpath = f'/home/xuguanyang/py/Differential_analysis/reference_data/final_bench/HAP1/{x}'
	# respath = f'/home/xuguanyang/py/Differential_analysis/reference_data/final_bench/HAP1/{x}_res'
	dirpath = f'/home/xuguanyang/py/Differential_analysis/reference_data/final_bench/TMT/real'
	respath = f'/home/xuguanyang/py/Differential_analysis/reference_data/final_bench/TMT/real_res'
	result = pd.DataFrame()
	# os.mkdir(respath)
...
# recall_res.to_csv('/home/xuguanyang/py/Differential_analysis/reference_data/final_bench/HAP1/recall_res.csv')
# precision_res.to_csv('/home/xuguanyang/py/Differential_analysis/reference_data/final_bench/HAP1/precision_res.csv')
# positive_precision_res.to_csv(
# 	'/home/xuguanyang/py/Differential_analysis/reference_data/final_bench/HAP1/positive_precision_res.csv')
